    ...
    public function addBook(ManagerRegistry $doctrine, Request $request): Response // Ajout du type de retour
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            if ($author) {
                ...
                // CORRECTION : em->persist($author) est inutile ici car l'auteur
                // est une entité existante sélectionnée depuis le formulaire (EntityType).
                // Doctrine gère la relation automatiquement lors du persist($book).
                // $em->persist($author); 
            }
